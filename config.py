...
# MISE API
MISE_SEARCH_URL = os.getenv("MISE_SEARCH_URL", "https://carburanti.mise.gov.it/ospzApi/search/zone")
MISE_DETAIL_URL = os.getenv("MISE_DETAIL_URL", "https://carburanti.mise.gov.it/ospzApi/registry/servicearea/{id}")
